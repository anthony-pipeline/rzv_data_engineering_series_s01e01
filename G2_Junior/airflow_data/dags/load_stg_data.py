...
@dag(default_args=default_args, description="ETL pipeline to load staging data from multiple sources",
     schedule_interval="*/3 * * * *", catchup=False)
def load_staging_data():
    ...
    def extract(table: str, conn_id: str, **context) -> str:
        ...
        if not max_loaded_dttm:
            ...
            sql = f"""select * from {table} where {increment_col} > '{max_loaded_dttm}'::timestamp;"""
